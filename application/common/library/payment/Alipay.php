...
class Alipay {
	...
	private $format = 'json';
	private $returnUrl = 'https://www.shisuixingdong.org/index.php/index/pay/resultPage_alipay';
	private $notifyUrl = 'https://www.shisuixingdong.org/index.php/index/pay/alipayCallback';
