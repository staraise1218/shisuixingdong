...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-nation" class="form-control" name="row[nation]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[sexdata]-<?php echo $key; ?>"><input id="row[sexdata]-<?php echo $key; ?>" name="row[sexdata]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"1"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-number" class="form-control" name="row[number]" type="text" value="<?php echo $number; ?>">
        </div>
    </div>
    <?php if($admin_id == 1): ?>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-family_status" class="form-control" name="row[family_status]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-needmoney" class="form-control" step="0.01" name="row[needmoney]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Needyear'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-needyear" class="form-control" name="row[needyear]" type="number" value="1">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[donation_status]-<?php echo $key; ?>"><input id="row[donation_status]-<?php echo $key; ?>" name="row[donation_status]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"1"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-detailcontent" class="form-control editor" rows="5" name="row[detailcontent]" cols="50"></textarea>
        </div>
    </div>
