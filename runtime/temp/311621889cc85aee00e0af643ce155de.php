...
<script type="text/javascript">
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-student_id" data-rule="required" data-source="student/index" class="form-control selectpage" name="row[student_id]" type="text" value="<?php echo $row['student_id']; ?>">
        </div>
    </div> -->
    <div class="form-group">
