<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"E:\PHPTools\www\shihuixingdong\public/../application/index\view\user\track.html";i:1534947174;s:69:"E:\PHPTools\www\shihuixingdong\application\index\view\common\top.html";i:1534920327;s:72:"E:\PHPTools\www\shihuixingdong\application\index\view\user\leftmenu.html";i:1534085994;s:72:"E:\PHPTools\www\shihuixingdong\application\index\view\common\footer.html";i:1534141675;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>善款追踪与学生近况</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="pa white_bg">
		<ol class="breadcrumb white_bg">
			<li><a href="/">首页</a></li>
			<li><a href="<?php echo url('index/user/index'); ?>">我的捐赠</a></li>
			<li class="active active_bread">善款追踪与学生近况</li>
		</ol>
	</div>
	<!-- 捐款 -->
	<div class="pa mycont">
		...
		<div class="mycont_list white_bg fr">
			...
			<div class="mycont_list_table">
				<div class="track_line">
					<span class="track_line_icon login_act iconfont icon-zuo-yuan" onclick="javascript:window.history.back(-1)"></span>
					<span class="track_word">善款追踪与学生近况</span>
				</div>
				<ul class="track_detail">
					...
					<li>
						<span class="track_icon login_act iconfont icon-circleyuanquan"></span>
						<div class="track_san"></div>
						<div class="track_pic">
							<p class="track_title">
