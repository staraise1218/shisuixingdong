...
<script type="text/javascript">
    ...
    <input id="c-student_id" data-rule="required"  name="row[student_id]" type="hidden" value="<?php echo $student_id; ?>">
